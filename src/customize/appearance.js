...
export const ACCENTS = {
  green:  { label: "Green",  light: { p: "#12894E", d: "#0C6A3C" }, dark: { p: "#37C878", d: "#2AAA64" } },
  teal:   { label: "Teal",   light: { p: "#0E8F86", d: "#0A6E67" }, dark: { p: "#2FD4C4", d: "#22A99C" } },
  blue:   { label: "Blue",   light: { p: "#2563EB", d: "#1D4ED8" }, dark: { p: "#6C9BFF", d: "#4E82F0" } },
  indigo: { label: "Indigo", light: { p: "#6D28D9", d: "#5B21B6" }, dark: { p: "#A78BFA", d: "#8B6DF0" } },
  orange: { label: "Orange", light: { p: "#EA7A17", d: "#C2610F" }, dark: { p: "#F6A24E", d: "#E0842E" } },
  rose:   { label: "Rose",   light: { p: "#E11D5C", d: "#BE123C" }, dark: { p: "#FB7199", d: "#F0507B" } },
};

/* Card-style presets → the --ag-card-* vars the Card primitive consumes. */
export const CARD_STYLES = {
  rounded:  { label: "Rounded",  radius: "var(--ag-r-lg)", shadow: "none",              border: "1px solid var(--ag-line)", bg: "var(--ag-surface)", backdrop: "none" },
  flat:     { label: "Flat",     radius: "var(--ag-r-md)", shadow: "none",              border: "1px solid var(--ag-line)", bg: "var(--ag-surface)", backdrop: "none" },
  material: { label: "Material", radius: "var(--ag-r-md)", shadow: "var(--ag-shadow-md)", border: "none",                    bg: "var(--ag-surface)", backdrop: "none" },
  glass:    { label: "Glass",    radius: "var(--ag-r-lg)", shadow: "var(--ag-shadow-sm)", border: "1px solid color-mix(in srgb, var(--ag-ink) 12%, transparent)", bg: "color-mix(in srgb, var(--ag-surface) 72%, transparent)", backdrop: "blur(12px) saturate(1.2)" },
};

export const DISPLAY_SIZES = {
  compact:     { label: "Compact",     zoom: 0.92 },
  comfortable: { label: "Comfortable", zoom: 1.0 },
  spacious:    { label: "Spacious",    zoom: 1.08 },
};

  ...
  return {
    ...
    sections: [
      ...
      { heading: "Cultivation Cost Breakdown", rows: [
        ...
        { label: "Crop protection cost", value: rupee(c.protection.total), i18n: { en: "Crop protection cost", hi: "फ़सल सुरक्षा लागत", bn: "ফসল সুরক্ষার খরচ" } },
        { label: "Organic input cost", value: rupee(c.organic.total), i18n: { en: "Organic input cost", hi: "जैविक इनपुट लागत", bn: "জৈব উপকরণের খরচ" } },
        { label: "Irrigation cost", value: rupee(c.irrigation.total), i18n: { en: "Irrigation cost", hi: "सिंचाई लागत", bn: "সেচের খরচ" } },
        { label: "Labour cost", value: rupee(c.labour.total), i18n: { en: "Labour cost", hi: "श्रम लागत", bn: "শ্রমের ব্যয়" } },
        { label: "Machinery cost", value: rupee(c.machinery.total), i18n: { en: "Machinery cost", hi: "मशीन लागत", bn: "যন্ত্রপাতির খরচ" } },
        { label: "Other cost", value: rupee(c.other.total), i18n: { en: "Other cost", hi: "अन्य लागत", bn: "অন্যান্য খরচ" } },
        { label: "Total cultivation cost", value: rupee(c.totalCost), i18n: { en: "Total cultivation cost", hi: "कुल खेती लागत", bn: "মোট চাষের খরচ" } },
        { label: "Cost / acre", value: rupee(c.costPerAcre), i18n: { en: "Cost / acre", hi: "प्रति एकड़ लागत", bn: "প্রতি একরের ব্যয়" } },
        { label: "Cost / hectare", value: rupee(c.costPerHectare), i18n: { en: "Cost / hectare", hi: "प्रति हेक्टेयर लागत", bn: "প্রতি হেক্টরে খরচ" } },
      ]},
      { heading: "Estimated Profitability (planning estimate, not guaranteed)", rows: [
        { label: "Estimated yield", value: c.yield.totalYield.toLocaleString("en-IN"), i18n: { en: "Estimated yield", hi: "अनुमानित उपज", bn: "আনুমানিক ফলন" } },
        { label: "Estimated revenue", value: rupee(c.revenue.total), i18n: { en: "Estimated revenue", hi: "अनुमानित आय", bn: "আনুমানিক আয়" } },
        { label: "Estimated profit", value: rupee(c.profit.gross), i18n: { en: "Estimated profit", hi: "अनुमानित लाभ", bn: "আনুমানিক মুনাফা" } },
        { label: "ROI", value: c.profit.roiPct === null ? "N/A" : `${c.profit.roiPct}%`, i18n: { en: "ROI", hi: "ROI", bn: "ROI" } },
        { label: "Cost / kg (or unit)", value: c.costPerKg === null ? "N/A" : rupee(c.costPerKg), i18n: { en: "Cost / kg (or unit)", hi: "प्रति किग्रा (या इकाई) लागत", bn: "প্রতি কেজি (বা ইউনিট) খরচ" } },
        { label: "Break-even price", value: c.breakEven.breakEvenPrice === null ? "N/A" : rupee(c.breakEven.breakEvenPrice), i18n: { en: "Break-even price", hi: "लागत-वसूली कीमत", bn: "খরচ-উসুল দাম" } },
      ]},
    ],
  };
}

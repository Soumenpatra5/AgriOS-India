...
const FarmSpaceHub       = lazy(() => import("../pages/farmSpace/FarmSpaceHub.jsx"));
...
const GoatMilkEntry      = lazy(() => import("../pages/farmSpace/GoatMilkEntry.jsx"));
...
const FishDashboard      = lazy(() => import("../pages/farmSpace/FishDashboard.jsx"));
const BeeDashboard       = lazy(() => import("../pages/farmSpace/BeeDashboard.jsx"));
const HiveDetail         = lazy(() => import("../pages/farmSpace/HiveDetail.jsx"));
const BeeFinance         = lazy(() => import("../pages/farmSpace/BeeFinance.jsx"));
const CropDashboard      = lazy(() => import("../pages/farmSpace/CropDashboard.jsx"));
const FieldDetail        = lazy(() => import("../pages/farmSpace/FieldDetail.jsx"));
const CropFinance        = lazy(() => import("../pages/farmSpace/CropFinance.jsx"));
const FarmSpaceAnalytics      = lazy(() => import("../pages/farmSpace/FarmSpaceAnalytics.jsx"));
const FarmSpaceNotifications  = lazy(() => import("../pages/farmSpace/FarmSpaceNotifications.jsx"));
const FishPondDetail     = lazy(() => import("../pages/farmSpace/FishPondDetail.jsx"));
const FishFinance        = lazy(() => import("../pages/farmSpace/FishFinance.jsx"));
const DairyAnimalDetail  = lazy(() => import("../pages/farmSpace/DairyAnimalDetail.jsx"));
const DairyFinance       = lazy(() => import("../pages/farmSpace/DairyFinance.jsx"));
const DairyMilkEntry     = lazy(() => import("../pages/farmSpace/DairyMilkEntry.jsx"));
const PoultryDashboard   = lazy(() => import("../pages/farmSpace/PoultryDashboard.jsx"));
const PoultryBatchDetail = lazy(() => import("../pages/farmSpace/PoultryBatchDetail.jsx"));
const PoultryChainDetail = lazy(() => import("../pages/farmSpace/PoultryChainDetail.jsx"));
...
const FarmSpaceTasks     = lazy(() => import("../pages/farmSpace/FarmSpaceTasks.jsx"));
const FarmSpaceAttendance = lazy(() => import("../pages/farmSpace/FarmSpaceAttendance.jsx"));
...
function StackScreen({ item }) {
  ...
  if (item.kind === "farmDetails") return <FarmDetails />;
  if (item.kind === "support") return <Support />;
  if (item.kind === "privacy") return <Privacy />;
  ...
  if (item.kind === "language") return <LanguageSettings />;
  ...
  if (item.kind === "poultryBatchFinance")  return <PoultryBatchFinance  {...(item.props || {})} />;
  ...
  if (item.kind === "farmSpaceAttendance")  return <FarmSpaceAttendance />;
  ...
  if (item.kind === "alertsCenter")         return <AlertsCenter />;
  return null;
}

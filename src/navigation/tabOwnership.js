...
const OWNER_TAB = {
  ...
  beeDashboard:           "farmSpace",
  hiveDetail:             "farmSpace",
  beeFinance:             "farmSpace",
  cropDashboard:          "farmSpace",
  fieldDetail:            "farmSpace",
  cropFinance:            "farmSpace",
  farmSpaceAnalytics:       "farmSpace",
  farmSpaceNotifications:   "farmSpace",
  poultryDashboard:       "farmSpace",
  poultryBatchDetail:     "farmSpace",
  poultryBatchFinance:    "farmSpace",
  poultryBatchHistory:    "farmSpace",
  poultryChainDetail:     "farmSpace",
  farmSpaceDm:            "farmSpace",
  farmSpaceDmInbox:       "farmSpace",

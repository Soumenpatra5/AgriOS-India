...
const MENU = [
  ...
  { kind: "goatDashboard",    perm: "farm.goat.view",       icon: "Beef",        a: "primary",
    label: { en: "Goat & Sheep",   hi: "बकरी व भेड़",       bn: "ছাগল ও ভেড়া" },
    desc:  { en: "Small ruminant herd, milk & weight records", hi: "बकरी-भेड़ झुंड, दूध और वजन रिकॉर्ड", bn: "ছোট রমিন্যান্ট পাল, দুধ ও ওজন রেকর্ড" } },
  { kind: "pigDashboard",     perm: "farm.pig.view",        icon: "PiggyBank",   a: "orange",
    label: { en: "Pig & Swine",    hi: "सूअर पालन",         bn: "শূকর পালন" },
    desc:  { en: "Swine herd, weight & health records",    hi: "सूअर झुंड, वजन और स्वास्थ्य रिकॉर्ड", bn: "শূকর পাল, ওজন ও স্বাস্থ্য রেকর্ড" } },
  { kind: "fishDashboard",    perm: "farm.fish.view",       icon: "Fish",        a: "blue",
    label: { en: "Fish & Aqua",    hi: "मत्स्य पालन",       bn: "মাছ চাষ" },
    desc:  { en: "Pond management, feed, water quality",   hi: "तालाब प्रबंधन, चारा, जल गुणवत्ता", bn: "পুকুর ব্যবস্থাপনা, খাদ্য, জলমান" } },
  { kind: "beeDashboard",     perm: "farm.bee.view",        icon: "Hexagon",     a: "orange",
    label: { en: "Beekeeping",     hi: "मधुमक्खी पालन",     bn: "মৌমাছি পালন" },
    desc:  { en: "Hive management, inspections, honey harvest", hi: "छत्ता प्रबंधन, निरीक्षण, मधु संग्रह", bn: "মৌচাক ব্যবস্থাপনা, পরিদর্শন, মধু সংগ্রহ" } },
  { kind: "cropDashboard",    perm: "farm.crop.view",       icon: "Sprout",      a: "primary",
    label: { en: "Crop & Fields",  hi: "फसल और खेत",         bn: "ফসল ও মাঠ" },
    desc:  { en: "Field management, sowing, activities, harvest", hi: "खेत प्रबंधन, बुवाई, गतिविधियाँ, कटाई", bn: "মাঠ ব্যবস্থাপনা, বপন, কার্যকলাপ, ফসল" } },
  { kind: "farmSpaceAnalytics", perm: "farm.view",           icon: "BarChart2",   a: "primary",
    label: { en: "Analytics",     hi: "विश्लेषण",           bn: "বিশ্লেষণ" },
    desc:  { en: "Cross-module revenue, cost & profit trends", hi: "सभी मॉड्यूल का राजस्व, लागत और लाभ", bn: "সব মডিউলের রাজস্ব, খরচ ও মুনাফার প্রবণতা" } },
  { kind: "farmSpaceNotifications", perm: "farm.view",      icon: "Bell",        a: "orange",
    label: { en: "Notifications", hi: "सूचनाएँ",            bn: "বিজ্ঞপ্তি" },
    desc:  { en: "Alerts for hives, ponds, fields & tasks",  hi: "छत्ता, तालाब, खेत और कार्य के अलर्ट", bn: "মৌচাক, পুকুর, মাঠ ও কাজের সতর্কতা" } },

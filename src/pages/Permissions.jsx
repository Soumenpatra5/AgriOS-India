  ...
  return (
    <>
      <AppBar title={tc({ en: "Permissions", hi: "अनुमतियाँ", bn: "অনুমতি" })} onBack={pop}
        action={<button onClick={refresh} aria-label={tc({ en: "Refresh", hi: "ताज़ा करें", bn: "রিফ্রেশ" })} style={{ background: T.surface, border: `1px solid ${T.line}`, borderRadius: 12, padding: 8, cursor: "pointer", color: T.ink, display: "flex" }}><Icon name="RefreshCw" size={18} /></button>} />
